...
class MSResidualBlock(nn.Module):
    ...
    This is a practical Milestone-1 implementation of the MS-residual principle:
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        membrane_current = self.main(x) + x  # x is binary; sum is internal membrane current.
